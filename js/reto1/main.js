...
const arraySeries = [serie1, serie2, serie3, serie4, serie5];
const arrayVideojuegos = [videojuego1, videojuego2, videojuego3, videojuego4, videojuego5];
serie2.entregar();
serie5.entregar();
...
console.log("--------------\n\n");
const contarEntregados = (entregables) => {
...
console.log("--------------\n\n");
const videojuegoMasLargo = (videojuegos) => {
